...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a.setEmail(user);
        a.setPass(pass);
        a = Controller.getInstance().loginAdmin(a);
        if (a == null) {
            JOptionPane.showMessageDialog(this, "NEUSPESNO", "NISU DOBRI PODACI", JOptionPane.ERROR_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "USPESNO", "DOBRI PODACI", JOptionPane.INFORMATION_MESSAGE);
